...
Light and dark mode are handled by **`next-themes`**. Dynamic metadata is implemented for SEO optimization. Complex layout animations are implemented thanks to **Motion** library.
