...
Authentication and authorization was implemented using **NextAuth**. Internationalization is supported thanks to **next-intl** library. Site is styled with **Tailwind** and can be used on variety of devices thanks to the responsive design. Application data is stored in **Supabase** database. Deployed on **Vercel**.
