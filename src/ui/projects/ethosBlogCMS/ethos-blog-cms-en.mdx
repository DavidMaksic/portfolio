...
Authentication, authorization and admin permissions are implemented using **Supabase Auth**. For writing articles, **BlockNote** text editor is used. Animations are implemented thanks to **Motion** library. Forms are handled by **React Hook Form**.
