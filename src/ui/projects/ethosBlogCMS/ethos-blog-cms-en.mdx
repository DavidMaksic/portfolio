...
import CmsImg20 from './../../../../public/extended-dashboard.webp';
import CmsImg21 from './../../../../public/cms-21.png';
import EmailImage from './../../../../public/cms-email.png';
...
Authentication, authorization and admin permissions are implemented using **Supabase Auth**. For writing articles, **BlockNote** text editor is used. As for responsive design, desktops and laptops are supported. Animations are implemented thanks to **Motion** library. Forms are handled by **React Hook Form**.

<br />

Site is styled with **Tailwind**, and thanks to the responsive design, site can be used on desktops and laptops. **React Router** handles the routing. Application data is stored in **Supabase** database. Deployed on **Vercel**.
...
Among other things, dashboard includes **Post Rankings**, which ranks all articles based on their popularity; **Traffic Sources** informs where users visit from, while the **Continue Writing** section shows drafted articles of the logged in author.

<br />

<ArticleImage image={CmsImg21} alt="Dashboard" />
...
<ArticleImage image={CmsImg19} alt="Admin permissions" height="h-150" />
...
After the above form is submitted, new author needs to confirm their account through email. When this is done, they will be granted access to the app.

<br />

<ArticleImage image={EmailImage} alt="Confirm email example" height="h-130" />
