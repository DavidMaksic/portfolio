...
function ProjectPreview({ projectData }) {
   ...
   return (
      <Link
         to={`/${projectURL}`}
         className="rounded-3xl flex flex-col shadow-preview overflow-hidden hover:translate-y-[-10px] transition duration-200 p-2 md:p-4 sm:p-2! gap-2 dark:bg-primary-300/15"
      >
         <img
            src={image}
